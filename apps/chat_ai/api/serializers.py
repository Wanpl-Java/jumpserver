...
from chat_ai.models import (
    Approval, Conversation, Message, MessageFeedback, MessageFile,
...
class MessageFeedbackSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('rating', 'reason', 'comment', 'date_updated')
        read_only_fields = ('date_updated',)

    def validate_reason(self, value):
        if sanitize_text(value) != value:
            raise serializers.ValidationError('Sensitive credentials cannot be stored in feedback.')
        return value
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'regenerated_from', 'feedback', 'date_created',
        )
        read_only_fields = fields
